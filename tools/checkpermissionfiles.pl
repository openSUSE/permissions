...
my @deflevels = ('easy', 'secure', 'restrictive', 'paranoid');

my @defpermfiles = ('permissions', 'permissions.easy', 'permissions.secure', 'permissions.restrictive', 'permissions.paranoid');

# filename
#   - level (DEFAULT, easy, secure, restrictive, paranoid)
#      - owner
#      - mode
my %perms;
